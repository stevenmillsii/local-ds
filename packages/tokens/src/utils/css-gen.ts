...
export function generateThemeCSS(theme: Theme): string {
  ...
  --font-mono: var(${prefix}-typography-fontFamily-mono);`.trim();

  return `/* Generated by @YOUR_ORG/tokens — do not edit manually. Run \`pnpm build\` in packages/tokens to regenerate. */
